...
//Ejercicio 10
let jugador1 = prompt ("Jugador 1 Ingrese 1 , 2 o 3 (1 para piedra,  2 para papel o 3 para tijeras)")
let jugador2 = prompt ("Jugador 2 Ingrese 1, 2 o 3 (1 para piedra,  2 para papel o 3 para tijeras)")
...
if ((a == 1) & (b == 2)) {
   return alert("Ganó Jugador 2!");
}
if ((a == 1) & (b == 3)) {
    return alert("Ganó Jugador 1!");
}
if ((a == 2) & (b == 1)) {
    return alert("Ganó Jugador 1!");
}
